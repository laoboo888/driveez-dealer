...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'CarDealerWeb/staticfiles_build', 'static')  # Ensure this path is correct

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'CarDealerWeb/cardealer/static'),  # Add paths where your static files are stored
]
